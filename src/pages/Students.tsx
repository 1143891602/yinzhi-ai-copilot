        ...
        {selected ? (
          <div className="w-72 shrink-0 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => navigate(`/lesson-plan?instrument=${encodeURIComponent(selected.instrument)}&level=${encodeURIComponent(selected.level)}&student=${encodeURIComponent(selected.name)}`)}
              ...
              <button
                onClick={() => {
                  ...
                  navigate(`/communication?studentId=${selected.id}&keywords=${encodeURIComponent(tags.join('、'))}`)
                }}
